        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="card card-box">
                    <div class="card-head">
                        <header>Update Department Details</header>


                    </div>
                    <div class="card-body " id="bar-parent">
                        <form method="post" action="{{ route('editDepartment',$department->id) }}" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" value="{{ $department->department_id }}" class="form-control" id='department_id'
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $department->departmentname }}"class="form-control" id='departmentname'
                            ...
                            <a href="{{ route('viewDepartment') }}" class="btn btn-info">View All</a>
