        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="card card-box">
                    <div class="card-head">
                        <header>Update Your General Information</header>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            @if($site->logo != "NULL")
                                                <div id="@if($site->logo != "NULL") logoSite @endif">
                                                    <img src="{{ asset('public/uploads/site/'.$site->logo) }}" alt="" width="200px">
                                                </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            @if($site->favicon != "NULL" )
                                                <div id="@if($site->favicon != "NULL") favicon @endif">
                                                    <img src="{{ asset('public/uploads/site/'.$site->favicon) }}" alt="" width="50px" >
                                                </div>
                                                @else
