...
@section('title') Update Level @endsection
...
<div class="page-content">
    <div class="page-bar">
        <div class="page-title-breadcrumb">
            <div class=" pull-left">
                <div class="page-title">Update Level</div>
            </div>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <div class="card card-box">
                <div class="card-head">
                    <header>Update Level</header>
                </div>
                <div class="card-body " id="bar-parent">
                    <form method="post" action="{{route('level.edit',$data->id)}}" enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="fname">Level</label>
                                <input type="text" class="form-control" id="level" placeholder="Enter Level" name="level" data-validation="length" value="{{$data->level}}" data-validation-length="3-400" data-validation-error-msg="Level is required (3-50 chars)">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea name="level_description" id="" cols="30" rows="5" placeholder="Job Description.." class="form-control">{{$data->level_description}}</textarea>
                            </div>
                        </div>

                        <button onclick=type="submit" class="btn btn-primary">Update Level</button>
