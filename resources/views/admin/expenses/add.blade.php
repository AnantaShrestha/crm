                        ...
                        <form method="post" action="{{route('expenses.store')}}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="date" value="{{old('Date')}}"
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter particular" id="particular" value="{{old('Particular')}}"
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" placeholder="Enter Amount" id="Amount" value="{{old('Amount')}}"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="category_id" id="category_id" class="form-control" data-validation="required" value="category_id"
                                            data-validation-error-msg="Select Category ID">
                                        <option selected disabled="">Select  Category Id
                                        </option>
                        ...
                        <div class="col-md-12">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter Paid By" id="paid_by" value=""
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="expenditure" id="expenditure" class="form-control" data-validation="required" value=""
                                        ...
                                        <option selected disabled="">Expenditure Status</option>
                         ...
                         <div class="col-md-12">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter Received By" id="received_by" value="{{old('received_by')}}"
