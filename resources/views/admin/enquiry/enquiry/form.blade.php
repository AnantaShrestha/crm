                                ...
                                <div class="col-md-6">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="enquiry_categories">Please Select Category
                                            </label>
                                            <select id="enquiry_categories" class="form-control enquiry-category-multiselect" name="enquiry_categories[]" multiple data-validation="required" data-validation-error-msg="At Least a  is required">
                                                @if(isset($categories))
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select id="source" class="form-control select2-multiple" name="source[]" multiple data-validation="required" data-validation-error-msg="At Least a  is required">
                                                @if(isset($sources))
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="name" value="{{ @$data->name }}" placeholder="Enter Title" name="name" data-validation="length" data-validation-length="3-400" data-validation-error-msg="Name is required (3-50 chars)">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" id="email" value="{{ @$data->email }}" placeholder="Enter email" data-validation="required" name="email" autocomplete="email">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="phone" class="form-control" id="phone" value="{{ @$data->phone }}" placeholder="Enter pnone" name="phone">
                                        </div>
                                    </div>
