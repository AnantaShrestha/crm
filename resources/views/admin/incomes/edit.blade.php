        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="card card-box">
                    <div class="card-head">
                        <header>Edit Income Details</header>
                    </div>
                    <div class="card-body " id="bar-parent">
                    <form method="post" action="{{route('income.incomes.update',$incomes->id)}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="paidby" value="{{$incomes->paidby}}"
                                ...
                                <div class="col-md-6">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="amount" value="{{$incomes->amount}}"
                                                   placeholder="Enter a Amount" name="amount" >
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="date" value="{{$incomes->date}}"
                                ...
                                <div class="col-md-6">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="receivedby" value="{{$incomes->receivedby}}"
                                ...
                                <div class="col-md-6">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="modeifpayment" value="{{$incomes->modeofpayment}}"
